...
const firebaseConfig = {
    apiKey: "ใส่_API_KEY_ของคุณที่นี่", // หาได้จาก Project Settings > General
    databaseURL: "https://foot-care-15028-default-rtdb.asia-southeast1.firebasedatabase.app",
    projectId: "foot-care-15028",
    appId: "ใส่_APP_ID_ของคุณที่นี่" // หาได้จาก Project Settings > General
};
...
onValue(ref(db, 'live/angleX'), (snapshot) => {
    ...
    if (currentAngle >= 0) {
        ...
        document.getElementById("livePlantar").innerText = "0";
    } else {
        document.getElementById("liveDorsi").innerText = "0";
...
// 3. เริ่มฝึก 5 เซ็ต (Dorsi 5 + Plantar 5 = 10 ครั้ง)
